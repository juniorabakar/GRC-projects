...
| 02 | [NIST CSF Capstone](./02_NIST_CSF_Capstone/) | `EN DÉPLOIEMENT` | Programme de cybersécurité complet basé sur le NIST Cybersecurity Framework |
| 03 | [TPRM](./03_TPRM/) | `EN DÉPLOIEMENT` | Évaluation des risques liés aux tiers — fournisseur SaaS fictif |
| 04 | [Incident Response Plan](./04_Incident_Response_Plan/) | `EN DÉPLOIEMENT` | Plan de réponse à incident pour une organisation fictive |
